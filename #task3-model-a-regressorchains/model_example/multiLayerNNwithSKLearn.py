...
#Design nn using Multi-Linear perceptron classifier. It requires the use of an activation function 
vTronMLPC = MLPClassifier(max_iter = 100, alpha = 1e-3, random_state = 1, solver = 'sgd',
                          learning_rate_init = 0.05, hidden_layer_sizes = (1000, 200, 10))
vTronMLPC.fit(X_train, Y_train)
#predicting with the aid of the perceptron
ypredictTrain = vTronMLPC.predict(X_train)
ypredictTest = vTronMLPC.predict(X_test)
