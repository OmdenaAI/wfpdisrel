...
namespace CyclonesDataAutoModel.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"/home/augustowski/repos/wfpdisrel/#task3-model/model-g-exploratory-models/auto-ml/ML.NET Model Builder in VisualStudio/data/OUTPUT_WBI_exposer_cyclones.csv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.TOTAL_AFFECTED} | Predicted value: {predictionResult.Score}");
